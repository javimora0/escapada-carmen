...
answerButtons.forEach(button => {
    ...
    button.addEventListener("click", () => {
        ...
        else if (currentQuestion.id === "question5") {

            showScreen("clue5");

        }

        else if (currentQuestion.id === "question6") {

            showScreen("clue6");

        }

        else if (currentQuestion.id === "question7") {

            showScreen("clue7");

        }

        else if (currentQuestion.id === "question8") {

            showScreen("clue8");

        }

        else if (currentQuestion.id === "question9") {

            showScreen("clue9");

        }

        else if (currentQuestion.id === "question10") {
